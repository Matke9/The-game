...
public class Pathfinding : MonoBehaviour {
    ...
    static public Grid GridReference;//For referencing the grid class
    ...
    internal static List<Node> GetFinalPath(object item1, object item2)
    {
        throw new NotImplementedException();
    }

    static public Tuple<Node, Node> FindPath(Vector3 a_StartPos, Vector3 a_TargetPos)
    {
        ...
        return new Tuple<Node, Node>(StartNode, TargetNode);
    }

    static public List<Node> GetFinalPath(Node a_StartingNode, Node a_EndNode)
    {
